...
In the next section, we explain some [mostly used database operations](/database/operations) to show how to perform data manipulation using the DB class, before we use a template controller to make our application output look good in a browser.
